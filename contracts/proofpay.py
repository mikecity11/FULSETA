...
class Fulseta(gl.contract.Contract):
    ...
    def evaluate_work(self, deal_id: str) -> None:
        ...
        def judge():
            ...
            evidence = page.body.decode("utf-8", errors="ignore")[:16000]

            prompt = f"""
You are FULSETA, an impartial work-verification judge.

Decide whether the public evidence satisfies the agreement.
...
{{
  ...
  "reasoning": "A short explanation based on the evidence."
}}
"""
...
The reasoning does not need identical wording, but it must be
substantively consistent about whether the submitted evidence
satisfies the material agreement requirements.
""",
        )
